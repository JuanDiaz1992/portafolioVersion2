import img1 from "../../img/newHome/bannerf-3.png"
...
import { Navigation } from 'swiper/modules';
    ...
    return(
        <>
                <Swiper navigation={true} modules={[Navigation]} className="mySwiper second_slider_container" viewport={{ once: true, amount: 1 }}>
                    <SwiperSlide className="firstSliderOf_thirty_slider">
                        ...
                        <div className="firstSliderOf_thirty_slider--div2">
                          <img src={img1} alt="" />
                          <motion.img className="img_slider3_first_slider" 
                                      src={img2} 
                                      alt="" 
                                      variants={objects}
                                      initial="offscreen"
