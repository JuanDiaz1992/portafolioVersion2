...
function Slider (){
    ...
    return(
        <>
                <Swiper navigation={true} modules={[Navigation]} className="mySwiper sixth_slider_container" viewport={{ once: true, amount: 1 }}>
                    <SwiperSlide className="sixth_slider_container--item1" >
                      <div className="header_card_slider sixth_slider_container-header_card-item1 ">
                          ...
                          <p> 
                              ...
                              una oportunidad para aprender y crecer.<br/>
                    ...
                    <SwiperSlide className="sixth_slider_container--item2">
                      <div className="header_card_slider sixth_slider_container-header_card-item2 ">
                          ...
                          <p> 
                            Proyecto de landing page para una tienda<br/>
                            de vinos, donde el diseño y la pasión <br/>
                            por el vino se combinan en una experiencia<br/>
                            cautivadora.
                          </p>
                          <Button onClick={()=>navigate("https://github.com/JuanDiaz1992/WineSur")} isIconOnly  color="primary" ><FaGithub/></Button>
                      </div>
                    ...
                    <SwiperSlide className="sixth_slider_container--item3">
                      <div className="header_card_slider sixth_slider_container-header_card-item3 ">
                          ...
                          <p> 
                            ...
                            encargada de la Ingeniería eléctrica.<br/>
                          </p>
                          <div>
                              <Button onClick={()=>navigate("https://gesthor.com.co/")} color="danger">Visita la web</Button>
                              <Button onClick={()=>navigate("https://github.com/JuanDiaz1992/gesthor")} isIconOnly  color="primary" ><FaGithub/></Button>
                          </div>
                      </div>
                    </SwiperSlide>
                    <SwiperSlide className="sixth_slider_container--item4">
                      <div className="header_card_slider sixth_slider_container-header_card-item4 ">
                          ...
                          <div>
                              ...
                              <Button onClick={()=>navigate("https://github.com/JuanDiaz1992/contador_de_votaciones")} isIconOnly  color="primary" ><FaGithub/></Button>
                          </div>
                      </div>
                    </SwiperSlide>
                    <SwiperSlide className="sixth_slider_container--item5">
                      <div className="header_card_slider sixth_slider_container-header_card-item5 ">
                          ...
                          <Button onClick={()=>navigate("https://github.com/JuanDiaz1992/BOOCIC")} isIconOnly  color="primary" ><FaGithub/></Button>
                      </div>
                    </SwiperSlide>
                </Swiper>
